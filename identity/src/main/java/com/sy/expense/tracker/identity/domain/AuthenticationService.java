...
public class AuthenticationService {
  ...
  private void assertPasswordNotSame(final EncryptedPassword encryptedUserPassword,
      final Password passwordToAssess) {

    checkArgument(encryptedUserPassword.getValue()
            .equals(encryptionService.encrypt(passwordToAssess.getValue())),
